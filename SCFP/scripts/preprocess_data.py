...
def main():
    ...
    parser.add_argument("--limit", type=int, default=None, help="Limit number of traces for debugging")
    ...
    # Load raw data (support both JSON and JSONL)
    ...
    # Clip traces if limit provided
    if args.limit:
        print(f"Limiting dataset to {args.limit} traces for debugging.")
