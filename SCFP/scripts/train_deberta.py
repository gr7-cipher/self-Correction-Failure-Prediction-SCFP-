...
def main():
    ...
    parser.add_argument("--three-stage", action="store_true", 
                       help="Use 3-stage training (Binary -> Multi-class -> Joint)")
    parser.add_argument("--epochs-binary", type=int, default=10, help="Epochs for Stage 1")
    parser.add_argument("--epochs-multiclass", type=int, default=15, help="Epochs for Stage 2")
    parser.add_argument("--epochs-joint", type=int, default=20, help="Epochs for Stage 3")
    ...
    if args.three_stage:
        training_history = trainer.train_3_stage(
            epochs_binary=args.epochs_binary,
            epochs_multiclass=args.epochs_multiclass,
